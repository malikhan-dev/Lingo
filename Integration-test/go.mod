...
require github.com/malikhan-dev/zenql/expressions/Sifu v1.0.4

replace github.com/malikhan-dev/zenql/expressions/Sifu => ../expressions/Sifu

require github.com/malikhan-dev/zenql/collections/Khan/v2 v2.0.5

replace github.com/malikhan-dev/zenql/collections/Khan/v2 => ./../collections/Khan/v2
